...
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1001, 'Ministério', 'Órgão responsável por uma área específica do governo', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1002, 'Secretarias', 'Órgãos que auxiliam o governo em sua área de atuação', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1003, 'Autarquia', 'Órgão com autonomia administrativa e financeira', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1004, 'Fundação', 'Órgão criado para fins específicos e de interesse público', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1005, 'Empresa Pública', 'Órgão que realiza atividades econômicas', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1006, 'Sociedade de Economia Mista', 'Órgão com capital misto público e privado', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1007, 'Agência Reguladora', 'Órgão responsável por regular setores específicos', 1000);
...
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1010, 'Centro de Pesquisa', 'Instituição voltada para pesquisas científicas e tecnológicas', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1011, 'Hospital Público', 'Unidade de saúde pública para atendimento à população', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1012, 'Escola Pública', 'Instituição de ensino fundamental e médio pública', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1013, 'Biblioteca Pública', 'Instituição que disponibiliza livros e recursos culturais', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1014, 'Polícia Militar', 'Órgão responsável pela segurança e ordem pública estadual', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1015, 'Polícia Civil', 'Órgão responsável pela investigação e repressão a crimes', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1016, 'Corpo de Bombeiros', 'Órgão responsável pelo combate a incêndios e salvamento', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1017, 'Assembléia Legislativa', 'Órgão legislativo estadual responsável pela criação de leis estaduais', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1018, 'Tribunal de Justiça', 'Órgão judiciário responsável por julgar casos no âmbito estadual', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1019, 'Supremo Tribunal Federal', 'Órgão judiciário máximo do país responsável por questões constitucionais', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1020, 'Tribunal Superior Eleitoral', 'Órgão responsável pela organização das eleições no país', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1021, 'Prefeitura', 'Órgão executivo municipal responsável pela administração local', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1022, 'Governo Estadual', 'Órgão executivo estadual responsável pela administração de um estado', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1023, 'Congresso Nacional', 'Sede do poder legislativo do país', 1000);
INSERT INTO orgaos_tipos (orgao_tipo_id, orgao_tipo_nome, orgao_tipo_descricao, orgao_tipo_criado_por) VALUES (1024, 'Governo Federal', 'Sede do poder executivo', 1000);
...
CREATE TABLE oficios(
    ...
    oficio_numero INT NOT NULL,
    oficio_ano INT NOT NULL,

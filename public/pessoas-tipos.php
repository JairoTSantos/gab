...
<head>
    ...
    <?php montarHeader('Tipos de pessoas'); ?>
</head>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid p-2">
                <?php navBar(); ?>
                <?php cardDescription('<i class="fa-solid fa-person"></i>Tipos de pessoas', '<p class="card-text mb-0">Por favor, preencha os campos para criar novos tipos de pessoas</p>'); ?>
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow-sm mb-2">
                            <div class="card-body p-2">
                                ...
                                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                                    ...
                                    $resultado = $pessoaController->novaTipoPessoa($tipo);
                                        ...
                                        <tbody>
                                            ...
                                            if ($buscaTipo['status'] === 'success') {
                                                ...
                                                foreach ($buscaTipo['dados'] as $tipo) {
                                                    echo '
                                                        <tr>
                                                            <td>' . $tipo['pessoa_tipo_nome'] . '</td>
                                                            <td>' . $tipo['pessoa_tipo_descricao'] . '</td>
                                                            <td>' . $tipo['usuario_nome'] . ' | ' . date('d/m : H:i', strtotime($tipo['pessoa_tipo_criado_em'])) . '</td>
                                                        </tr>
                                                    ';
                                                }

<div class="border-end bg-white" id="sidebar-wrapper">
    ...
    <p style="margin-left: 17px; margin-top:20px;font-weight: bolder;" class="text-muted mb-2"><i class="fas fa-bars"></i> Legislativo</p> 
        ...
        <a class="list-group-item list-group-item-action list-group-item-light px-3" href="./orgaos"><i class="fas fa-hotel"></i> Órgãos e instituições</a>
        <a class="list-group-item list-group-item-action list-group-item-light px-3" href="./pessoas"><i class="fas fa-user-friends"></i> Pessoas</a> 
    </div>
</div>